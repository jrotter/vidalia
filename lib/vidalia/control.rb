module Vidalia
  ...
  class Control < VidaliaArtifact
    ...
    # *Example*
    #
    #   newcontrol = Vidalia::Control.new(
    #     :name => "User ID",
    #     :logtext = "user ID"
    #   )
    def initialize(opts = {})
    o = {
      ...
      if @aliases
        unless @aliases.is_a?(Array)
          raise "Vidalia::Control requires aliases to be an array"
        end
        @aliases.each do |my_alias|
          raise "Vidalia::Control requires each alias in the array to be a string" unless my_alias.is_a?(String)
        end
      end
    ...
    # *Options*
    #
    # +page+:: specifies a Vidalia::Page object to add this Control to
    #
    # *Example*
    #
    #   loginpage = Vidalia::Page.new(
    #     :name => "Login Page"
    #   )
    #   newcontrol = Vidalia::Control.new(
    #     :name => "User ID",
    ...
    # *Options*
    #
    # +region+:: specifies a Vidalia::Region object to add this Control to
    #
    # *Example*
    #
    #   user = Vidalia::Region.new(
    #     :name => "User"
    #   )
    #   newcontrol = Vidalia::Control.new(
    #     :name => "Edit User",
    ...
    def add_generic_navigate()
      add_navigate { |opts|
        Vidalia.log("Navigating to #{@logtext}")
        goto(opts)
      }
    end
