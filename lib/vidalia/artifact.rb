module Vidalia
  ...
  class VidaliaArtifact

    # Constructor for the VidaliaArtifact.
    #
    # *Options*
    #
    ...
    # Define the presence check method for a given VidaliaArtifact
    #
    # *Options*
    #
    ...
    #     Vidalia::browser.h1(:text => "Vidalia Example Page").present?
    #   }
    #
    def add_check(&block)
      @check_method = block
    ...
    # Check if the VidaliaArtifact is present
    #
    # *Options*
    #
    ...
    # Define the present directive for a given VidaliaArtifact
    #
    # *Options*
    #
    ...
    # Is the VidaliaArtifact present?
    #
    # *Options*
    #
